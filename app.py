...
def create_pdf(book_title, chapters):
    ...
    pdf.cell(0, 60, book_title, align="C", new_x="LMARGIN", new_y="NEXT")
    ...
    for ch in chapters:
        if ch.get('content'):
            ...
            pdf.cell(0, 10, f"Chapter {ch['chapter_number']}: {ch['title']}", new_x="LMARGIN", new_y="NEXT")
            pdf.ln(5)
    ...
    with tool_col2:
        ...
        if st.button("📄 Compile Markdown"):
            ...
            st.download_button(
                label="⬇️ Download (.md)",
                data=full_text,
                file_name=f"{selected_book['title'][:20]}.md",
                mime="text/markdown"
            )
            ...
            with st.spinner("Generating PDF..."):
                try:
                    ...
                    st.download_button(
                        ...
                        data=pdf_bytes,
                        file_name=f"{selected_book['title'][:20]}.pdf",
